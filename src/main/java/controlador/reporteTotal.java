 ...
 * @author KandL
 */
public class reporteTotal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ListaAlumnos li = new ListaAlumnos(año);
        ...
        request.getSession().setAttribute("sec", secci);
        request.getSession().setAttribute("lista", ve2);
        request.getRequestDispatcher("reporteTotalNota.jsp").forward(request, response);
    }}
    }
