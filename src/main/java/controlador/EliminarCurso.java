...
public class EliminarCurso extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ListaCursos cursos = new ListaCursos(año);
        cursos.select();
        Curso cur = new Curso(curso);
        
        if (cur.eliminar(curso) == false) {
            String error = "No se Elimino el Curso eliminelo de Asignaciones";
