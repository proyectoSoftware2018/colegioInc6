...
<%
   ...
   String grado = (String)request.getSession().getAttribute("grado");
                ...
                <section>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-12 col-md-12 col-lg-12">
                            <form action="controladoreditargrado.do" method="post">
                                ...
                                <div class="form-row justify-content-center">
                                    ...
                                    <div class="card card-inverse bg-dark" >
                                        <div class="card-block">
                                            <h3 class="card-title text-center">EDICIÓN DE GRADOS DE ESTUDIO:</h3><br>
                                            <label for="gradoanti">Nombre de Grado Actual:</label>
                                            <input type="text" class="form-control" id="grado" name="gradoanti" value="<%out.print(grado);%>" readonly="readonly"><br>
