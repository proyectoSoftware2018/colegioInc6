                ...
                <section>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-12 col-md-12 col-lg-12">
                            <form action="controladorcurso.do" method="post">
                                <input name="an" type="text" style="visibility: hidden; width: 1px; height: 1px;" value="<%out.print(anio);%>">
                                <div class="form-row justify-content-center">

                                    <div class="card card-inverse bg-dark" >
                                        <div class="card-block">
                                            <h3 class="card-title text-center">REGISTRO DE CURSOS:</h3><br>
                                            <label for="cod">Código Curso:</label>
                                            <input type="text" class="form-control" id="cod" name="cod" placeholder="MAT"><br>
                                            <label for="nom">Nombre del Curso:</label>
                                            <input type="text" class="form-control" id="nom" name="nom" placeholder="MATEMATICA"><br>
